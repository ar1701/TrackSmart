...
async function testEndpoints() {
  ...
  const tests = [
    ...
    { name: 'Provider Logout API', url: 'http://localhost:4000/api/providers/logout', method: 'POST' },
    { name: 'Accept Request API', url: 'http://localhost:4000/api/providers/requests/test123/accept', method: 'POST' },
    { name: 'Reject Request API', url: 'http://localhost:4000/api/providers/requests/test123/reject', method: 'POST' }
  ];
