...
async function testProviderEndpoints() {
  ...
  try {
    ...
    const logoutResponse = await fetch(
      `http://localhost:${PORT}/api/providers/logout`,
      {
        method: "POST",
        headers: {
    ...
    const acceptResponse = await fetch(
      `http://localhost:${PORT}/api/providers/requests/test123/accept`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    ...
    const rejectResponse = await fetch(
      `http://localhost:${PORT}/api/providers/requests/test123/reject`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
